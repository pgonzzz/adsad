...
import PropiedadFormFields, { propiedadFormToPayload, propiedadToForm } from '../components/PropiedadFormFields';
...
export default function Propiedades() {
  ...
  const openEdit = (p, e) => {
    e.stopPropagation();
    setEditing(p);
    setForm({ ...propiedadToForm(p), notas: p.notas || '' });
    setFotos(p.fotos || []);
